      ...
      <div className="content">
        ...
        <div className="content__row skills-wrapper">
          ...
          <div>
            ...
            <p>Есть небольшой опыт работы с бекендом: Node.js, Express, PHP, MySQL. Не будет проблемы найти общий язык с
              программистами backend.</p>
          </div>
          <div>
            <h3>Сборка</h3>
          ...
          <div>
            ...
            <p>Тестирую свой код на разных устройствах и браузерах</p>
          </div>
        </div>
      </div>
    );
